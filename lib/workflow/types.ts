...
export const NODE_TYPES: Record<string, NodeTypeDefinition> = {
  ...
  'google-sheets': {
    ...
    icon: 'Table',
    color: '#34a853',
    defaultConfig: { credentialId: '', resource: 'sheet', spreadsheetId: '', title: '', sheets: '[]', sheetName: '', range: '', operation: 'read', values: '[]', columns: '{}', options: '{}' },
    configSchema: [
      credentialField,
      {
        key: 'resource',
      ...
      { key: 'spreadsheetId', label: 'Spreadsheet ID', type: 'text', placeholder: 'Required for read/write/append' },
      { key: 'title', label: 'New Sheet Title', type: 'text', placeholder: 'Required for create' },
      { key: 'sheets', label: 'Sheets (JSON array)', type: 'json', placeholder: '["Sheet1"]' },
      { key: 'sheetName', label: 'Sheet Name', type: 'text', placeholder: 'Sheet1' },
      { key: 'range', label: 'Range (e.g., Sheet1!A1:D10)', type: 'text' },
